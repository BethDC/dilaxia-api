...
(
    ...
    CONSTRAINT ruolo_esistente CHECK (ruolo IN ("S", "I", "E", "A"))
);
++
...
(
    ...
    livello_professionalita varchar(1)  NOT NULL, -- Da controllare
    CONSTRAINT liv_professionalita_esistente CHECK (livello_professionalita IN ("P", "I", "A")
        );
...
(
    ...
    id_sport      smallint(4) NOT NULL,
    id_campo      smallint(4) NOT NULL,
